...
struct btrfs_kobject_attr btrfs_attr_##_name = \
 ...
 *	2. release function
 *	3. default_attrs
 * We have defined a generic sysfs_ops and release functions for 
 * btrfs_kobjects and in nearly all the case btrfs_sysfs_ops and
 * btrfs_kobject_release should suffice.
 */
